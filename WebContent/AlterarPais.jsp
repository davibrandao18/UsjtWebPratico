        	...
        	<form action="ManterPais.do" method="post">
	            ...
	            <div class="row">
	                <div class="form-group col-md-6">
	                    ...
	                    <input type="number" class="form-control" name="populacao" id="populacao" required maxlength="15" placeholder="quantidade da população" value="${pais.populacao}">
	                </div>
	
	                <div class="form-group col-md-6">
	                    <label for="area">Área</label>
	                    <input type="number" class="form-control" name="area" id="area" required maxlength="60" placeholder="área" value="${pais.area}">
	                </div>
	            </div>
	            <hr />
